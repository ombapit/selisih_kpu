<button name="kembali" onclick="get_suara(<?php echo $prov_id;?>)" class="btn btn-primary marbot">Kembali</button>
<table class="table table-bordered table-striped">
	...
	<tr>
		...
		<?php } else { ?>
			<td><a href="javascript:void(0)" onclick="get_suara(<?php echo $prov_id;?>,<?php echo $row->id_kab;?>,<?php echo $row->id;?>)"><?php echo $row->nama;?></a></td>
